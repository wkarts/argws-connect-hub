module Redis::RedisKeys
  ...
  HUB_INSTALLATION_ONBOARDING = 'HUB_INSTALLATION_ONBOARDING'.freeze
  HUB_INSTALLATION_CONFIG_RESET_WARNING = 'HUB_CONFIG_RESET_WARNING'.freeze
  LATEST_HUB_VERSION = 'LATEST_HUB_VERSION'.freeze
