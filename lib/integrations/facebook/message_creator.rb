...
class Integrations::Facebook::MessageCreator
  ...
  def perform
    ...
    # rescue => e
    # HubExceptionTracker.new(e).capture_exception
    # end
  end
  ...
  def agent_message_via_echo?
    # TODO : check and remove send_from_hub_app if not working
    response.echo? && !response.sent_from_hub_app?
    # this means that it is an agent message from page, but not sent from hub.
