...
RSpec.describe Account do
  ...
  describe 'usage_limits' do
    ...
    it 'returns HubApp.max limits' do
      expect(account.usage_limits).to eq({ agents: HubApp.max_limit, inboxes: HubApp.max_limit })
    end
  end
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@hub.com')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@hub.com' do
        expect(account.support_email).to eq('support@hub.com')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@hub.com' do
        expect(account.support_email).to eq('hello@hub.com')
      end
    end
