...
grep -Fq 'argws-connect-hub:${VERSION}' .github/workflows/publish_main_amd64.yml || fail "release must publish X.Y.Z"
grep -Fq 'argws-connect-hub:latest' .github/workflows/publish_main_amd64.yml || fail "release must publish latest"
grep -Fq 'argws-connect-hub:main' .github/workflows/publish_main_amd64.yml || fail "release must publish main"
...
grep -Fq 'ghcr.io/${{ github.repository_owner }}/argws-connect-hub' .github/workflows/publish_main_amd64.yml || fail "canonical package argws-connect-hub missing"
