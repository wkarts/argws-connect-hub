class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_hub_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_HUB_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless HubCaptcha.new(params[:h_captcha_client_response]).valid?
  end
