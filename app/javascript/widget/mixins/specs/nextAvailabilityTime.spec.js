...
describe('nextAvailabilityTimeMixin', () => {
  ...
  beforeEach(() => {
    window.hubWebChannel = hubWebChannel;
  });

  afterEach(() => {
    delete window.hubWebChannel;
  });
  ...
  it('should return channelConfig', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.channelConfig).toEqual(hubWebChannel);
  });
  ...
  it('should return workingHours', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.workingHours).toEqual(hubWebChannel.workingHours);
  });
  ...
  it('should return currentDayWorkingHours', () => {
    ...
    const expectedWorkingHours = hubWebChannel.workingHours.find(
  ...
  it('should return hoursAndMinutesBackInOnline', () => {
    ...
    const currentDayCloseHour =
      hubWebChannel.workingHours[wrapper.vm.currentDay].close_hour;
    const nextDayOpenHour =
      hubWebChannel.workingHours[
  ...
  it('should return in 30 minutes', () => {
    ...
    hubWebChannel.workingHours[4].open_hour = 18;
    hubWebChannel.workingHours[4].open_minutes = 0;
    hubWebChannel.workingHours[4].close_hour = 23;
  ...
  it('should return in 3 hours', () => {
    ...
    hubWebChannel.workingHours[4].open_hour = 19;
  ...
  it('should return at 10:00 AM', () => {
    ...
    hubWebChannel.workingHours[4].open_hour = 10;
  ...
  it('should return tomorrow', () => {
    ...
    hubWebChannel.workingHours[4].open_hour = 9;
    hubWebChannel.workingHours[4].close_hour = 16;
  ...
  it('should return on Saturday', () => {
    ...
    hubWebChannel.workingHours[4].open_hour = 9;
    hubWebChannel.workingHours[4].close_hour = 16;
    hubWebChannel.workingHours[5].closed_all_day = true;
