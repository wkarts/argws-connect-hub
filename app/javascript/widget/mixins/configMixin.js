export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.hubWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.hubWebChannel.avatarUrl;
    },
    channelConfig() {
    ...
    preChatFormEnabled() {
      return window.hubWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.hubWebChannel.preChatFormOptions || {};
