...
export default {
  ...
  mounted() {
    const { websiteToken, locale, widgetColor } = window.hubWebChannel;
  ...
  methods: {
    ...
    setLocale(localeWithVariation) {
      ...
      const { enabledLanguages } = window.hubWebChannel;
    ...
    registerCampaignEvents() {
      ...
      emitter.on('execute-campaign', campaignDetails => {
        ...
        const { websiteToken } = window.hubWebChannel;
...
<style lang="scss">
@import '~widget/assets/scss/hub.scss';
</style>
