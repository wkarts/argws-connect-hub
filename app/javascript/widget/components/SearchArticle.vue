<script>
import { debounce } from '@hub/utils';
export default {
  props: {
    placeholder: {
      type: String,
...
<template>
  <div class="relative flex items-center">
    ...
    <input
      ...
      type="text"
      name="search"
      class="block w-full h-8 px-2 pl-6 pr-1 m-0 text-sm border rounded-md focus-visible:outline-none text-slate-800 border-slate-100 bg-slate-75 placeholder:text-slate-400 focus:ring focus:border-hub-500 focus:ring-hub-200 hover:border-hub-200"
      @input="handleInput"
    />
