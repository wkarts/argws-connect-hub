...
import { HUB_ON_START_CONVERSATION } from '../constants/sdkEvents';
...
export default {
  ...
  computed: {
    ...
    hideReplyBox() {
      const { allowMessagesAfterResolved } = window.hubWebChannel;
  ...
  methods: {
    ...
    startNewConversation() {
      ...
      IFrameHelper.sendMessage({
        event: 'onEvent',
        eventIdentifier: HUB_ON_START_CONVERSATION,
