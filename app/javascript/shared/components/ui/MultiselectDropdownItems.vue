  ...
  <div class="dropdown-wrap">
    ...
    <div class="flex justify-start items-start flex-auto overflow-auto">
      <div class="w-full max-h-[10rem]">
        <HubDropdownMenu>
          <HubDropdownItem v-for="option in filteredOptions" :key="option.id">
            <hub-button
...
.search-input {
  @apply m-0 w-full border border-solid border-transparent h-8 text-sm text-slate-700 dark:text-slate-100 rounded-md focus:border-hub-500 bg-slate-50 dark:bg-slate-900;
}
