  ...
  <section class="flex flex-col w-full h-full bg-slate-25">
    ...
    <div class="w-full px-8 py-6">
      <textarea
        ...
        :rows="4"
        class="resize-none block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border !outline-2 border-slate-100 focus:ring-hub-500 focus:border-hub-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-hub-500 dark:focus:border-hub-500"
