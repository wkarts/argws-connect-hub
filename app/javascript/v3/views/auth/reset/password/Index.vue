...
<template>
  <div
    class="flex flex-col justify-center w-full min-h-full py-12 bg-hub-25 sm:px-6 lg:px-8 dark:bg-slate-900"
  >
    <form
    ...
    >
      ...
      <p
        class="mb-4 text-sm font-normal leading-6 tracking-normal text-slate-600 dark:text-hub-50"
      >
        {{
          useInstallationName(
      ...
      <p class="mt-4 -mb-1 text-sm text-slate-600 dark:text-hub-50">
