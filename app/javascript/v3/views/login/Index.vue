...
import { parseBoolean } from '@hub/utils';
...
export default {
  ...
  computed: {
    ...
    showGoogleOAuth() {
      return Boolean(window.hubConfig.googleOAuthClientId);
    },
    showSignupLink() {
      return parseBoolean(window.hubConfig.signupEnabled);
    },
  },
  created() {
...
<template>
  ...
  >
    <section class="max-w-5xl mx-auto">
      ...
      />
      <h2
        class="mt-6 text-3xl font-medium text-center text-slate-900 dark:text-hub-50"
      >
        {{
