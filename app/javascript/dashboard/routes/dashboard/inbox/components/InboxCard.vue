...
<template>
  ...
  >
    <div class="relative flex items-center justify-between w-full">
      <div
        v-if="isUnread"
        class="absolute ltr:-left-3.5 rtl:-right-3.5 flex w-2 h-2 rounded bg-hub-500 dark:bg-hub-500"
      />
    ...
    <div v-if="snoozedUntilTime" class="flex items-center">
      <span class="text-xs font-medium text-hub-500 dark:text-hub-500">
        {{ snoozedDisplayText }}
      </span>
    </div>
    <InboxContextMenu
