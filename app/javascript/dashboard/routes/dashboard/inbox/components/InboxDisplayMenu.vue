      ...
      displayOptions: [
        {
          ...
          key: hubConstants.INBOX_DISPLAY_BY.SNOOZED,
          selected: false,
          type: hubConstants.INBOX_FILTER_TYPE.STATUS,
        },
        {
          name: this.$t('INBOX.DISPLAY_MENU.DISPLAY_OPTIONS.READ'),
          key: hubConstants.INBOX_DISPLAY_BY.READ,
          selected: false,
          type: hubConstants.INBOX_FILTER_TYPE.TYPE,
        },
      ],
      sortOptions: [
        {
          name: this.$t('INBOX.DISPLAY_MENU.SORT_OPTIONS.NEWEST'),
          key: hubConstants.INBOX_SORT_BY.NEWEST,
          type: hubConstants.INBOX_FILTER_TYPE.SORT_ORDER,
        },
        {
          name: this.$t('INBOX.DISPLAY_MENU.SORT_OPTIONS.OLDEST'),
          key: hubConstants.INBOX_SORT_BY.OLDEST,
          type: hubConstants.INBOX_FILTER_TYPE.SORT_ORDER,
        },
      ],
      activeSort: hubConstants.INBOX_SORT_BY.NEWEST,
      activeDisplayFilter: {
        status: '',
        type: '',
      },
    ...
    saveSelectedDisplayFilter() {
      this.updateUISettings({
        inbox_filter_by: {
          ...
          sort_by: this.activeSort || hubConstants.INBOX_SORT_BY.NEWEST,
        },
      });
    },
    setSavedFilter() {
      ...
      this.activeSort = sortBy || hubConstants.INBOX_SORT_BY.NEWEST;
      this.displayOptions.forEach(option => {
        option.selected =
          option.type === hubConstants.INBOX_FILTER_TYPE.STATUS
            ? option.key === status
            : option.key === type;
      ...
      <div class="relative">
        ...
        >
          <div
            ...
            :class="{
              'bg-hub-50 dark:bg-hub-700/50': activeSort === option.key,
            }"
            @click.stop="onSortOptionClick(option)"
          >
            <span
              class="text-xs font-medium hover:text-hub-600 dark:hover:text-hub-600"
              :class="{
                'text-hub-600 dark:text-hub-600': activeSort === option.key,
            ...
            <fluent-icon
              ...
              icon="checkmark"
              size="14"
              class="text-hub-600 dark:text-hub-600"
            />
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <input
            ...
            class="m-0 border-[1.5px] shadow border-slate-200 dark:border-slate-600 appearance-none rounded-[4px] w-4 h-4 dark:bg-slate-800 focus:ring-1 focus:ring-slate-100 dark:focus:ring-slate-700 checked:bg-hub-600 dark:checked:bg-hub-600 after:content-[''] after:text-white checked:after:content-['✓'] after:flex after:items-center after:justify-center checked:border-t checked:border-hub-700 dark:checked:border-hub-300 checked:border-b-0 checked:border-r-0 checked:border-l-0 after:text-center after:text-xs after:font-bold after:relative after:-top-[1.5px]"
