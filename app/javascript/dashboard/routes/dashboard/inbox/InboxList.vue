...
export default {
  ...
  data() {
    return {
      ...
      status: '',
      type: '',
      sortOrder: hubConstants.INBOX_SORT_BY.NEWEST,
  ...
  methods: {
    ...
    onFilterChange(option) {
      const { STATUS, TYPE, SORT_ORDER } = hubConstants.INBOX_FILTER_TYPE;
    ...
    setSavedFilter() {
      ...
      this.status = status;
      this.type = type;
      this.sortOrder = sortBy || hubConstants.INBOX_SORT_BY.NEWEST;
      this.$store.dispatch(
