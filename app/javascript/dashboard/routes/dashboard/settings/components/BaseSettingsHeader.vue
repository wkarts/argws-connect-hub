  ...
  <div class="flex flex-col items-start w-full gap-2 pt-4">
    ...
    <div class="flex items-center justify-between w-full gap-4">
      <div class="flex items-center gap-3">
        <div
          v-if="iconName"
          class="flex items-center w-10 h-10 p-1 rounded-full bg-hub-25/60 dark:bg-hub-900/60"
        >
          <div
            class="flex items-center justify-center w-full h-full rounded-full bg-hub-75/70 dark:bg-hub-800/40"
          >
            <fluent-icon
              size="14"
              :icon="iconName"
    ...
    <div class="flex flex-col gap-3 text-slate-600 dark:text-slate-300 w-full">
      ...
      <CustomBrandPolicyWrapper :show-on-custom-branded-instance="false">
        <a
          ...
          class="sm:inline-flex hidden gap-1 w-fit items-center text-hub-500 dark:text-hub-500 text-sm font-medium hover:underline"
        >
          {{ linkText }}
          <fluent-icon
            size="16"
