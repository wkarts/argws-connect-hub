...
import { getQuantileIntervals } from '@hub/utils';
...
function getHeatmapLevelClass(value) {
  ...
  const classes = [
    'bg-hub-50 dark:bg-hub-800/40 dark:outline-hub-800/80',
    'bg-hub-100 dark:bg-hub-800/30 dark:outline-hub-800/80',
    'bg-hub-200 dark:bg-hub-500/40 dark:outline-hub-700/80',
    'bg-hub-300 dark:bg-hub-500/60 dark:outline-hub-600/80',
    'bg-hub-600 dark:bg-hub-500/80 dark:outline-hub-500/80',
    'bg-hub-800 dark:bg-hub-500 dark:outline-hub-400/80',
  ];
