...
import ConnectApiConfiguration from './settingsPage/ConnectApiConfiguration.vue';
...
export default {
  ...
  computed: {
    ...
    whatsAppAPIProviderName() {
      ...
      if (this.isAConnectApiChannel) {
        return this.$t('INBOX_MGMT.ADD.WHATSAPP.PROVIDERS.CONNECT_API');
      }
      return '';
    },
    tabs() {
    ...
    <div v-if="selectedTabKey === 'inbox_settings'" class="mx-8">
      ...
      >
        ...
        <label v-if="isAWebWidgetInbox" class="w-3/4 pb-4">
          ...
          <hub-color-picker v-model="inbox.widget_color" />
        </label>
          ...
          <div class="flex flex-col items-start gap-2 mt-2">
            ...
            <div v-if="showBusinessNameInput" class="flex gap-2 w-[80%]">
              <input
                ...
                type="text"
              />
              <hub-button color-scheme="primary" @click="updateInbox">
                {{
                  $t(
