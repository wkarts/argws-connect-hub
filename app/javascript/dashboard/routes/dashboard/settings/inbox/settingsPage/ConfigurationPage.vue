...
<template>
  <div v-if="isATwilioChannel" class="mx-8">
    ...
    >
      <hub-code :script="inbox.callback_webhook_url" lang="html" />
    </SettingsSection>
  </div>
  ...
  <div v-else-if="isAWebWidgetInbox">
    <div class="mx-8">
      ...
      >
        <hub-code :script="inbox.hmac_token" />
        <template #subTitle>
  ...
  <div v-else-if="isAPIInbox" class="mx-8">
    ...
    >
      <hub-code :script="inbox.inbox_identifier" />
    </SettingsSection>
  ...
  <div v-else-if="isAnEmailChannel">
    <div class="mx-8">
      ...
      >
        <hub-code :script="inbox.forward_to_email" />
      </SettingsSection>
    </div>
  ...
  <div v-else-if="isAWhatsAppChannel && !isATwilioChannel">
    <div v-if="inbox.provider_config" class="mx-8">
      ...
      >
        <hub-code :script="inbox.provider_config.webhook_verify_token" />
      </SettingsSection>
      <SettingsSection
        :title="$t('INBOX_MGMT.SETTINGS_POPUP.WHATSAPP_SECTION_TITLE')"
        :sub-title="$t('INBOX_MGMT.SETTINGS_POPUP.WHATSAPP_SECTION_SUBHEADER')"
      >
        <hub-code :script="inbox.provider_config.api_key" />
      </SettingsSection>
      <SettingsSection
