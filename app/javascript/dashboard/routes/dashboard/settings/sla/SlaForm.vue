...
import { convertSecondsToTimeUnit } from '@hub/utils';
  ...
  <div class="flex flex-col h-auto overflow-auto">
    <form class="flex flex-wrap mx-0" @submit.prevent="onSubmit">
      ...
      >
        ...
        <hub-switch id="sla_bh" v-model="onlyDuringBusinessHours" />
      </div>

      <div class="flex items-center justify-end w-full gap-2 mt-8">
        <hub-button
          class="px-4 rounded-xl button clear outline-hub-200/50 outline"
