...
import ReplyBottomPanel from 'dashboard/components/widgets/HubWriter/ReplyBottomPanel.vue';
import ArticleSearchPopover from 'dashboard/routes/dashboard/helpcenter/components/ArticleSearch/SearchPopover.vue';
import MessageSignatureMissingAlert from './MessageSignatureMissingAlert';
import Banner from 'dashboard/components/ui/Banner.vue';
import { REPLY_EDITOR_MODES } from 'dashboard/components/widgets/HubWriter/constants';
import HubMessageEditor from 'dashboard/components/widgets/HubWriter/Editor.vue';
import HubAudioRecorder from 'dashboard/components/widgets/HubWriter/AudioRecorder.vue';
