...
<template>
  <div
    ...
    :class="{
      'active animate-card-select bg-slate-25 dark:bg-slate-800 border-hub-500':
        isActiveChat,
...
.conversation {
  ...
  .checkbox-wrapper {
    @apply h-10 w-10 flex items-center justify-center rounded-full cursor-pointer mt-4 hover:bg-hub-100 dark:hover:bg-hub-800;
