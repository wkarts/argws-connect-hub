...
.wrap {
  > .bubble {
    ...
    &.is-private .file.message-text__wrap {
      .file--icon {
        @apply text-hub-400 dark:text-hub-400;
      }
    ...
    &.is-private.is-text > .message-text__wrap .link {
      @apply text-hub-600 dark:text-hub-200;
    }
...
li.has-bg {
  @apply bg-hub-75 dark:bg-hub-600;
}
...
.right .bubble .text-content {
  p code {
    @apply bg-hub-600 dark:bg-hub-600 text-white dark:text-white;
  }

  pre {
    @apply bg-hub-800 dark:bg-hub-800 border-hub-700 dark:border-hub-700 text-white dark:text-white;
  ...
  blockquote {
    @apply border-l-4 border-solid border-hub-400 dark:border-hub-400 text-white dark:text-white;

    p {
      @apply text-hub-75 dark:text-hub-75;
    }
  }
}
</style>
