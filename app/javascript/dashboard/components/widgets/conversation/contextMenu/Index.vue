...
export default {
  ...
  data() {
    return {
      STATUS_TYPE: hubConstants.STATUS_TYPE,
      unreadOption: {
  ...
  computed: {
    ...
    showSnooze() {
      ...
      return this.status === hubConstants.STATUS_TYPE.OPEN;
    },
  },
  mounted() {
