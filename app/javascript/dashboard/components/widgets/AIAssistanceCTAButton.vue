...
<template>
  <div class="relative">
    ...
    <div
      class="radar-ping-animation absolute top-0 right-0 -mt-1 -mr-1 rounded-full w-3 h-3 bg-hub-500 dark:bg-hub-500"
    />
    <div
      class="absolute top-0 right-0 -mt-1 -mr-1 rounded-full w-3 h-3 bg-hub-500 dark:bg-hub-500 opacity-50"
    />
  </div>
</template>
