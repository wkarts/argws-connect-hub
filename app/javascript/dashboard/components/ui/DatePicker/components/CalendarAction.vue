  ...
  <div class="flex items-start justify-between w-full h-9">
    ...
    <div class="flex items-center gap-1">
      <button
        ...
        class="p-0 text-sm font-medium text-center text-slate-800 dark:text-slate-50 hover:text-hub-600 dark:hover:text-hub-600"
      ...
      <button
        ...
        :class="{ 'hover:text-hub-600 dark:hover:text-hub-600': viewMode }"
