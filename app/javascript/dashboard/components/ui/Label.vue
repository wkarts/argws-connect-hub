<script>
import { getContrastingTextColor } from '@hub/utils';
...
.label {
  ...
  /* Color Schemes */
  &.primary {
    @apply bg-hub-100 dark:bg-hub-100 text-hub-900 dark:text-hub-900 border border-solid border-hub-200;

    a {
      @apply text-hub-900 dark:text-hub-900;
    }
    .label-color-dot {
      @apply bg-hub-600 dark:bg-hub-600;
    }
  }
  &.secondary {
