...
import HubAnnouncementPopup from '../AnnouncementPopup.vue';
...
const Template = (args, { argTypes }) => ({
  ...
  components: { HubAnnouncementPopup },
  template:
    '<hub-announcement-popup v-bind="$props" @open="onClickOpenPath" @close="onClickClose"></hub-announcement-popup>',
});
