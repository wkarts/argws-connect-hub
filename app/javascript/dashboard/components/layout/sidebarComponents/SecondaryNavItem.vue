  ...
  computed: {
    ...
    computedClass() {
      ...
      if (
        ...
        return 'bg-hub-25 dark:bg-slate-800 text-hub-500 dark:text-hub-500 hover:text-hub-500 dark:hover:text-hub-500 active-view';
      }
      if (this.hasSubMenu) {
        if (
    ...
    >
      ...
      <span
        ...
        :class="{
          ...
          'bg-hub-75 dark:bg-hub-200 text-hub-600 dark:text-hub-600':
            isActiveView,
