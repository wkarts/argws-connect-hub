...
json.message_attributes resource.message_attributes
json.channel_capabilities resource.channel_capabilities
...
json.materials resource.materials do |material|
  json.id material.id
  json.filename material.filename.to_s
  json.content_type material.content_type
  json.byte_size material.byte_size
  json.signed_id material.blob.signed_id
end
