...
# Azure Blob ActiveStorage adapter from RubyGems. No git-hosted vendor fork.
...
gem 'devise', '>= 4.9.4'
# Upstream Devise password-policy extension from RubyGems.
...
# HTML-to-text converter from RubyGems (Ruby 3.3 compatible).
gem 'html2text', '0.5.0'
